...
function IModelPicker(props: IModelPickerProps) {
  const { project, onSelect, onLoaded, signedIn } = props;
  ...
  React.useEffect(() => {
    ...
    fetchModels();
  }, [isMountedRef, onLoaded, project, signedIn]);
...
function ProjectPicker(props: ProjectPickerProps) {
  ...
  React.useEffect(() => {
    ...
    fetchProjects();
  }, [isMountedRef, projectSource, search, signedIn]);
